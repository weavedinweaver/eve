...
class Eve(Flask, Events):
    ...
    def __init__(self, import_name=__package__, settings='settings.py',
                 validator=ValidatorSQL, data=None, auth=None, redis=None,
    ...
    def _set_resource_defaults(self, resource, settings):
        ...
        # Adding custom parameters defult value
        ...
        # For custom url logic <prefix>/<entity>/<pk>/<item>
        settings.setdefault('custom_url_logic', False)        
